    ...
    layout
    {
        area(content)
        {
            repeater(General)
            {
                ...
                field("Allocation No. L365"; Rec."Allocation No. L365")
                {
                    ApplicationArea = All;
                }
                ...
                field("Applies-ID L365"; Rec."Applies-ID L365")
                {
                    ApplicationArea = All;
                }
                ...
                field("Approved By L365"; Rec."Approved By L365")
                {
                    ApplicationArea = All;
                }
                field("Area"; Rec."Area")
                ...
                field("Bill-to Contact Phone No. L365"; Rec."Bill-to Contact Phone No. L365")
                {
                    ApplicationArea = All;
                }
                ...
                field("Combined Job Allocation L365"; Rec."Combined Job Allocation L365")
                {
                    ApplicationArea = All;
                }
                ...
                field("Copy of Invoice No. L365"; Rec."Copy of Invoice No. L365")
                {
                    ApplicationArea = All;
                }
                ...
                field("Created By L365"; Rec."Created By L365")
                {
                    ApplicationArea = All;
                }
                ...
                field("Disbursment Period Filter L365"; Rec."Disbursment Period Filter L365")
                {
                    ApplicationArea = All;
                }
                ...
                field("Document Delivery Method L365"; Rec."Document Delivery Method L365")
                {
                    ApplicationArea = All;
                }
                ...
                field("Extended Reference L365"; Rec."Extended Reference L365")
                {
                    ApplicationArea = All;
                }
                ...
                field("External Invoice Period L365"; Rec."External Invoice Period L365")
                {
                    ApplicationArea = All;
                }
                field("Foreign VAT No. L365"; Rec."Foreign VAT No. L365")
                {
                    ApplicationArea = All;
                }
                field("Full Copy Mode L365"; Rec."Full Copy Mode L365")
                {
                    ApplicationArea = All;
                }
                ...
                field("Global Relation 1 Code L365"; Rec."Global Relation 1 Code L365")
                {
                    ApplicationArea = All;
                }
                field("Global Relation 2 Code L365"; Rec."Global Relation 2 Code L365")
                {
                    ApplicationArea = All;
                }
                field("Global Relation 3 Code L365"; Rec."Global Relation 3 Code L365")
                {
                    ApplicationArea = All;
                }
                ...
                field("IC Invoice L365"; Rec."IC Invoice L365")
                {
                    ApplicationArea = All;
                }
                ...
                field("Invoice Period Filter L365"; Rec."Invoice Period Filter L365")
                {
                    ApplicationArea = All;
                }
                field("Invoice Status L365"; Rec."Invoice Status L365")
                {
                    ApplicationArea = All;
                }
                field("Invoicing frequency L365"; Rec."Invoicing frequency L365")
                {
                    ApplicationArea = All;
                }
                ...
                field("Job Net Change (LCY) L365"; Rec."Job Net Change (LCY) L365")
                {
                    ApplicationArea = All;
                }
                field("Job No. L365"; Rec."Job No. L365")
                {
                    ApplicationArea = All;
                }
                ...
                field("Next invoicing date L365"; Rec."Next invoicing date L365")
                {
                    ApplicationArea = All;
                }
                ...
                field("Original Invoice No. L365"; Rec."Original Invoice No. L365")
                {
                    ApplicationArea = All;
                }
                ...
                field("Pay-to Bank Account Info L365"; Rec."Pay-to Bank Account Info L365")
                {
                    ApplicationArea = All;
                }
                ...
                field("Posted Settlement No. L365"; Rec."Posted Settlement No. L365")
                {
                    ApplicationArea = All;
                }
                ...
                field("Re-Open Invoice No. L365"; Rec."Re-Open Invoice No. L365")
                {
                    ApplicationArea = All;
                }
                field("Re-Open Old Invoice L365"; Rec."Re-Open Old Invoice L365")
                {
                    ApplicationArea = All;
                }
                field(ReOpenJobLedgerEntriesL365; Rec.ReOpenJobLedgerEntriesL365)
                {
                    ApplicationArea = All;
                }
                ...
                field("Regarding L365"; Rec."Regarding L365")
                {
                    ApplicationArea = All;
                }
                field("Rent Contract No. L365"; Rec."Rent Contract No. L365")
                {
                    ApplicationArea = All;
                }
                ...
                field("Reversed By L365"; Rec."Reversed By L365")
                {
                    ApplicationArea = All;
                }
                ...
                field("Total Disbursment Amount L365"; Rec."Total Disbursment Amount L365")
                {
                    ApplicationArea = All;
                }
                field("Total Fee L365"; Rec."Total Fee L365")
                {
                    ApplicationArea = All;
                }
